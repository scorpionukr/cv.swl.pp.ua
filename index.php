...
<head>
	...
	<script>
		...
		fbq('init', '753136968368260');
		fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
		src="https://www.facebook.com/tr?id=753136968368260&ev=PageView&noscript=1"/>
	</noscript>
...
<body>
	...
	<div class="pusher">
		...
		<div class="ui grid three column pad-30">
			<div class="row">
				<div class="column">
					<p class="copyr">Coded and Designed by Black Sun Solutions &copy; 2016-2022.</p>
				</div>
				<div class="column">
				</div>
